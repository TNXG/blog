    ...
    var loadMoreBtn = `
      ...
      <div id="cf-footer" class="cf-new-add">
       ...
       <span class="cf-data-lastupdated">更新于：${sdata.last_updated_time}</span>
        Powered by <a target="_blank" href="https://github.com/Rock-Candy-Tea/hexo-circle-of-friends" target="_blank">FriendCircle</a><br><a target="_blank" href="../links" target="_blank">前往友情链接原页面</a>
      </div>
    ...
    if (start < articleNum) {
        ...
        <div class="cf-article">
          ...
          <div class="cf-article-avatar no-lightbox flink-item-icon">
            <img class="cf-img-avatar avatar" src="${item.avatar}" alt="avatar" onerror="this.src='${fdata.error_img}'; this.onerror = null;" loading="lazy">
        ...
        // 文章加载到底
        document.getElementById('cf-more').outerHTML = `<div id="cf-more" class="cf-new-add" onclick="loadNoArticle()"><small>哟吼，到底了哦！点我回到顶部</small></div>`
    }
}
// 打印个人卡片 cf-overshow
    ...
    var showHtml = `
        <div class="cf-overshow">
          <div class="cf-overshow-head">
            <img class="cf-img-avatar avatar" src="${userinfo.avatar}" alt="avatar" onerror="this.src='${fdata.error_img}'; this.onerror = null;" loading="lazy">
